    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#03010E] text-[#e8e8e8]'>
        <div> 
            ...
            <ul className='hidden md:flex items-center'>
                <li><a className='text-[#b2fefd]'>i. </a>Home</li>
        ...
        <div onClick={handleClick} className='md:hidden z-10'>
          {!nav ? <FaBars /> : <FaTimes />}
             ...
             {/*mobile menu*/}
         <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#03010E] flex flex-col justify-center items-center'}>
         ...
         <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300'>
            <a
              ...
              href='/'
            >
              Resume <BsFillArrowDownCircleFill size={30} className='text-[#e8e8e8]'/>
            </a>
          </li>
          </ul>
         </div>
